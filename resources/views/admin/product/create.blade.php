                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-9 pd0">
                                                <div class="input-group">
                                                    <input id="product-color-0" class="form-control" type="text" name="productColor[]" required value="">
                                                    <span class="input-group-btn">
        ...
        function addColorProduct() {
            ...
            var html = '<div class="form-group product-' + numberColor + '">'
                            + '<div class="col-sm-3">'
                                ...
                                + '<div class="col-sm-10 pd0">'
                                    + '<div class="input-group">'
                                        + '<input id="thumbnail-' + numberColor + '" class="form-control" type="text" name="color[]" required value="">'
                                        + '<span class="input-group-btn">'
                            ...
                            + '<div class="col-sm-4">'
                                ...
                                + '<div class="col-sm-9 pd0">'
                                    + '<div class="input-group">'
                                        + '<input id="product-color-' + numberColor + '" class="form-control" type="text" name="productColor[]" required value="">'
                                        + '<span class="input-group-btn">'
